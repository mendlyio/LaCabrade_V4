      ...
      <div className="bg-white border-b border-gray-200">
        <div className="content-container py-4">
          <nav className="flex items-center flex-wrap gap-1.5 text-sm">
              ...
              categoryBreadcrumb.map((category) => (
                <span key={category.id} className="flex items-center gap-1.5">
                  ...
                  <LocalizedClientLink
                    ...
                    className="text-gray-500 hover:text-amber-600 transition-colors whitespace-nowrap"
                  >
                    {category.name}
                  </LocalizedClientLink>
                </span>
            ...
            {/* Produit (non cliquable) */}
            <span className="flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5 text-gray-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
              <span className="font-medium text-gray-900 truncate max-w-[200px] sm:max-w-xs lg:max-w-md" title={product.title}>
                {product.title}
              </span>
            </span>
          </nav>
