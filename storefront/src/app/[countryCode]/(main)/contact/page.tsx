          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-pink-50 rounded-xl border-2 border-amber-200 p-6">
              ...
              <div className="flex gap-3">
                ...
                <a
                  href="https://storefront-production-03a4.up.railway.app/fr/contact"
                  target="_blank"
                  rel="noreferrer"
                  className="w-10 h-10 rounded-full bg-white border-2 border-amber-300 hover:bg-amber-600 hover:border-amber-600 flex items-center justify-center text-gray-600 hover:text-white transition-all duration-200 hover:scale-110"
                  aria-label="Contact La Cabrade"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H8l-4 3v-3H4a2 2 0 01-2-2V5z" />
                  </svg>
                </a>
              </div>
            </div>
