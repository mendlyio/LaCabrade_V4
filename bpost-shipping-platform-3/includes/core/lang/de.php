...
return array(
	...
	'automaticexportdescription' =>  'Alle Aufträge mit dem folgenden Status automatisch an Bpost senden',
	...
	'exportdescription' => 'In der Bestellübersicht gibt es zwei Möglichkeiten, Bestellungen an Bpost zu exportieren:

<p><b>Voreingestellte Bestellstatus nach Bpost exportieren</b><br/>
...
Diese Option befindet sich in der Dropdown-Liste "Massenaktionen". Diese Aktion exportiert alle Aufträge, die in der Auftragsübersicht mit einem Häkchen versehen sind, unabhängig vom Status.</p>',
	'statusdescription' => "In der Bestellübersicht fügt das Plugin eine zusätzliche Spalte mit dem Namen 'Bpost Status / Aktion' hinzu. In dieser Spalte wird ein Status pro Auftrag angezeigt.
<br/><b>Bewegen Sie den Mauszeiger über das Statussymbol, um den Exportverlauf der Bestellung zu sehen</b><br/><br/>Der Exportstatus wird im Folgenden aufgeführt',
    ...
    'labeltermsintro' => "<p>Neben der Möglichkeit, Sendungen manuell oder automatisch nach Bpost zu exportieren und von dort aus Etiketten zu erstellen, ist es auch möglich, Etiketten direkt aus WooCommerce heraus zu erstellen.</p>
    ...
    <ol class=\"Bpost-list\">
	<li>Die Bestelldaten werden nach Bpost exportiert, so dass nach erfolgreicher Übermittlung ein Versandetikett an WooCommerce zurückgeschickt werden kann.</li>
	<li>Das Format des zurückgesendeten Versandetiketts kann in der Bpost Versandplattform über "Einstellungen" > "Druckeinstellungen" > "Etikettendruckformat" eingestellt werden.</li>
	...
	<li>Wenn keine Auswahl für einen bestimmten Versanddienst und mögliche Versandoptionen getroffen wurde, wird automatisch der Versanddienst ausgewählt, wie er in der Bpost Versandplattform unter "Einstellungen" > "Standardeinstellungen" > "Versandart" > "Standardversandart" eingestellt ist.</li>
    ...
    <li>Wählen Sie Bpost: Etikett drucken aus der Dropdown-Liste der Mehrfachaktionen aus.</li>
 ...
 <br/><small>Weitere Informationen finden Sie auf der Registerkarte Hilfe</small>",
    'useapihelp' => '<p>Wenn Sie den Auftragsstatus so konfiguriert haben, dass er bei bestimmten Ereignissen automatisch aktualisiert wird (beim Import, bei der Erstellung des Etiketts und/oder bei der Lieferung), Sie aber bei den Aktualisierungen der Sendungsverfolgung in Ihrem Bpost-Konto "nicht gefunden" sehen, führen Sie bitte die folgenden Schritte aus:
<ol>
    <li>Aktivieren Sie die Option "WordPress-API für Auftragsaktualisierungen verwenden" unten.%s </li>
    <li>Gehen Sie zu Ihrem Bpost-Konto und erstellen Sie neue Schlüssel unter "Einstellungen" > "Integrationen" > "Schlüsselverwaltung" und aktivieren Sie die Schlüssel.</li>
    <li>Fügen Sie diese neuen Schlüssel in das Feld Bpost Credentials in den Bpost-Einstellungen hier in WordPress ein und klicken Sie auf die Schaltfläche "Änderungen speichern".</li>
</ol>', 
'hideifclasspresent' => 'Wenn mindestens ein Artikel im Warenkorb diese Klassen enthält, zeigen Sie diese Methode nicht an',
    ...
    'Select' => 'Ausgewählte',
    'Choose pickup location' => 'Abholort wählen'
);
