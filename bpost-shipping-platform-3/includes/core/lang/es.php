<?php  
return array( 
    'Bpostcolumntitle' => 'Estado / Acción',
    'automaticexport' => 'Exportación automática',
    'automaticexportdescription' => 'Enviar pedidos para Bpost cuando el estado coincida con',
...
<br/>Los estados de exportación se enumeran a continuación',
    ...
    <ol class="Bpost-list">
    <li>  El pedido se exporta a Bpost y los detalles del pedido se transmiten al transportista para que, si el envío es exitoso, podamos enviar una etiqueta de envío de vuelta a la plataforma de compras.</li>
    <li>  Puedes configurar el formato de la etiqueta en la app de Bpost "Ajustes" > "Impresión" > "Imprimir formato de etiqueta"</li>
    ...
    <li>  Si su cliente elige uno de los transportistas de Bpost en el momento de la compra, el transportista y las opciones que haya establecido para él en woocommerce, siempre que sean válidas para el envío, se asignarán al mismo </li>
    <li> En caso de que no haya ningún transportista de Bpost asociado al pedido, se elegirá automáticamente el transportista establecido en el portal de envíos de Bpost en "Configuración" > "Configuración por defecto" > "Transportista por defecto"</li>
    ...
    <li> Si se ha equivocado, puede contactar con Bpost a través de la sección de soporte la app de Bpost y le ayudaremos. El tiempo es primordial, por favor confirme si la etiqueta es correcta después de recibirla.</li>
    </ol>',
    ...
    <li>Seleccione Bpost: imprimir etiqueta, en el desplegable de acciones en lote</li>
...
//  WOO SPECIFIC STUFF 
    ...
    'setcredentials' => 'claves inválidas! Confirme en Configuración de Bpost si los copió correctamente',
...
//  Marketplace 
    'sending' => 'Enviando ...',
    'requestaccount' => 'Solicitar cuenta Bpost para este vendedor',
    ...
    'connect2Bpost' => 'Conectar con Bpost',
    'disconnectBpost' => 'Desconectarse de Bpost',
    'welcometitle' => 'Bienvenido a Bpost & PakketMail',
   ...
   'feature2description' => 'Reúne diferentes opiniones y posibilidades en una sencilla plataforma online.  <br/><br/>Múltiples transportistas, Registro de envíos, Todos los canales de venta',
    ...
    'Bpostsettings' => 'Finalizar Instalación',
    'whopays' => 'Quién paga Bpost?',
    'you' => 'Usted',
    'yourvendors' => 'Sus Vendedores',
    'whopaysdescription' => 'Si paga Bpost, todos los proveedores que realicen envíos con Bpost heredarán las tarifas que defina.',
